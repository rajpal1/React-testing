...
describe("Test the Login Component", () => {
  ...
  test("email input field should accept email ", () => {
    ...
    userEvent.type(email, "rajpal");
    expect(email.value).not.toMatch("rajpal@gmail.com");
  });
  ...
  test("should display alert if error", () => {
    ...
    userEvent.type(email, "rajpaldiwaker");
    userEvent.type(password, "ABC@123#xyz");
  ...
  test("should be able to submit the form", () => {
    ...
    userEvent.type(email, "rajpal@gmail.com");
    userEvent.type(password, "123456");
    userEvent.click(btnList[0]);

    const user = screen.getByText("rajpal@gmail.com");
